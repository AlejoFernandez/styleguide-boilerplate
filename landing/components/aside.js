...
export default React.createClass({
  render: function() {
    return (
      ...
      <div role="complementary" className="aside-styleguide">
        <header className="header">
          ...
          <button data-toggle="collapse" data-target="#menu" className="navbar-toggle collapsed" aria-expanded="false"><span className="sr-only">Toggle navigation</span><span className="icon-bar" /><span className="icon-bar" /><span className="icon-bar" /></button>
        </header>
        <div id="menu" className="collapse" aria-expanded="false">
          <nav className="nav-styleguide">
